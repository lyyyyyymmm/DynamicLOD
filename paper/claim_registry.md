...
| --- | --- | --- | --- |
| C1 | The proposed method lowers P95-window violation rate versus reactive and PI control. | Complete six-method D1/S2 blocks on two PCs and one Android, device-stratified Wilcoxon-Holm results, effect sizes and CIs. | `UNMEASURED` |
...
| C4 | Request feedback provides additional value during cold-cache interaction or pressure-burst workloads. | D1 pressure-workload no-request ablation on all physical devices after the v2.3.6 PC-A pilot gate is frozen. | `UNMEASURED` |
